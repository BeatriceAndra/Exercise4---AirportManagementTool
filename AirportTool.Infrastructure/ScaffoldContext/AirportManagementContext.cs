    ...
    public class AirportManagementContext : IdentityDbContext<ApiUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Airline>(entity =>
            {
                ...
                entity.Property(e => e.Id).ValueGeneratedNever();
                entity.Property(e => e.IATACode).HasMaxLength(2).IsFixedLength();
            ...
            modelBuilder.Entity<Airport>(entity =>
            {
                ...
                entity.HasIndex(e => e.IATACode).IsUnique();
                entity.Property(e => e.Id).ValueGeneratedNever();
                entity.Property(e => e.IATACode).HasMaxLength(3).IsFixedLength();
            ...
            modelBuilder.Entity<Flight>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.AirlineId, e.FlightNumber });
                entity.HasIndex(e => new { e.OriginAirportId, e.DestinationAirportId });
                entity.Property(e => e.Id).ValueGeneratedNever();
            ...
            modelBuilder.Entity<FlightSchedule>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.FlightId, e.ScheduledDepartureUtc });
                entity.Property(e => e.Id).ValueGeneratedNever();
            ...
            modelBuilder.Entity<Gate>(entity =>
            {
                ...
                entity.ToTable("Gate");
                entity.HasIndex(e => new { e.AirportId, e.Code }).IsUnique();
                entity.Property(e => e.Id).ValueGeneratedNever();
            ...
            modelBuilder.Entity<Ticket>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.FlightScheduleId, e.FareClass });
                entity.Property(e => e.Id).ValueGeneratedNever();
